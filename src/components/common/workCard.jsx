  ...
  <div className="card-body">
    ...
    <BackSide style={cardBackStyle} >
      <div>
              ...
              <span style={{textAlign:"justify", paddingLeft:"15px", paddingRight:"15px" , textDecoration:"underline" , cursor:"pointer"}} 
                onClick={_=>
                  { 
                    if (cardData.link)
        ...
        <ModalBody>
          {/* {cardData.link} */}
        <CarouselComp ChildComp={WorkDetail} disableArrowsOnEnd={false} itemPadding={[10,10,10,10]}  showArrows={true} objList={workDetail}/>
